...
public interface NumberConversionSoapType {
    ...
    @RequestWrapper(localName = "NumberToWords", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "es.unican.ss.Practica3.estimacionesTUS.numberToWords.NumberToWords")
    @ResponseWrapper(localName = "NumberToWordsResponse", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "es.unican.ss.Practica3.estimacionesTUS.numberToWords.NumberToWordsResponse")
    ...
    @RequestWrapper(localName = "NumberToDollars", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "es.unican.ss.Practica3.estimacionesTUS.numberToWords.NumberToDollars")
    @ResponseWrapper(localName = "NumberToDollarsResponse", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "es.unican.ss.Practica3.estimacionesTUS.numberToWords.NumberToDollarsResponse")
