 ...
 * generated in the es.unican.ss.Practica3.estimacionesTUS.numberToWords package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.unican.ss.Practica3.estimacionesTUS.numberToWords
     * 
     */
